...
def ove_launch_video_func(lang):
    if lang.lower() == 'english':
        ...
        url = 'http://gdo-appsdev.dsi.ic.ac.uk:9080/app/videos'
        try:
            webbrowser.open(url)
...
def ove_launch_video_space_func(text,lang):  
    if lang.lower() == 'english':
        if  text.lower() == 'video 9':
            space = Space(ove_host="gdo-appsdev.dsi.ic.ac.uk", space_name="DOCluster", control_port=9080)
            space.enable_online_mode()
            space.enable_browser_opening()

            video = space.add_section(w=2880, h=1616, x=720, y=404, app_type='videos')
            video.set_url('http://www.youtube.com/embed/QJo-VFs1X5c')
        ...
        elif text.lower() == 'video 4':
            space = Space(ove_host="gdo-appsdev.dsi.ic.ac.uk", space_name="LocalFour", control_port=9080)
            space.enable_online_mode()
            space.enable_browser_opening()
    ...
    if lang.lower() == 'english':
        if  text.lower() == 'play':
            ...
            if search_text.lower() == 'play all':
                url = "http://gdo-appsdev.dsi.ic.ac.uk:9080/app/videos/operation/play"
                r = requests.post(url)
                ...
                url = "http://gdo-appsdev.dsi.ic.ac.uk:9080/app/videos/operation/play?loop=true&oveSectionId=" + sectionID
                r = requests.post(url)
                speak_text = "play video " + search_text.lower() + ", done."
                tts.speak(speak_text=speak_text,language=lang)
            ...
            if search_text.lower() == 'pause all':
                url = "http://gdo-appsdev.dsi.ic.ac.uk:9080/app/videos/operation/pause"
                r = requests.post(url)
                ...
                sectionID = search_text
                url = "http://gdo-appsdev.dsi.ic.ac.uk:9080/app/videos/operation/pause?loop=true&oveSectionId=" + sectionID
                r = requests.post(url)
                speak_text = "pause video " + search_text.lower() + ", done."
                tts.speak(speak_text=speak_text,language=lang)
            ...
            if search_text.lower() == 'mute all':
                url = "http://gdo-appsdev.dsi.ic.ac.uk:9080/app/videos/operation/mute"
                r = requests.post(url)
                ...
                sectionID = search_text
                url = "http://gdo-appsdev.dsi.ic.ac.uk:9080/app/videos/operation/mute?loop=true&oveSectionId=" + sectionID
                r = requests.post(url)
                speak_text = "mute video " + search_text.lower() + ", done."
                tts.speak(speak_text=speak_text,language=lang)
            ...
            if search_text.lower() == 'stop all':
                url = "http://gdo-appsdev.dsi.ic.ac.uk:9080/app/videos/operation/stop"
                r = requests.post(url)
                ...
                sectionID = search_text
                url = "http://gdo-appsdev.dsi.ic.ac.uk:9080/app/videos/operation/stop?loop=true&oveSectionId=" + sectionID
                r = requests.post(url)
                speak_text = "stop video " + search_text.lower() + ", done."
                tts.speak(speak_text=speak_text,language=lang)
